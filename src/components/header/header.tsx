...
export const Header = () => {
    ...
    return (
        ...
        ${pathname === '/' ? 'bg-orange-700/5 border-orange-700/10' : pathname === '/about' ? 'bg-linear-to-br from-background via-background to-teal-700/5 border-teal-700/10' : 'bg-linear-to-br from-background via-background to-teal-700/10 border-teal-700/10'}
        border-b
        backdrop-blur-sm`}>
